...
class Video:
    ...
    def to_dict(self, **kwargs):
        ...
        snippet = {
            ...
            "live_status": self.snippet.get("liveBroadcastContent"),
            "local_title": self.snippet.get("localized", {}).get("title"),
            "local_description": self.snippet.get("localized", {}).get("description"),
        }
        
        content = {
            "duration": self.content_detail.get("duration"),
            "dimension": self.content_detail.get("dimension"),
            "definition": self.content_detail.get("definition"),
            "caption": self.content_detail.get("caption"),
            "license_status": self.content_detail.get("licensedContent"),
            "allowed_region": self.content_detail.get("regionRestriction", {}).get("allowed"),
            "blocked_region": self.content_detail.get("regionRestriction", {}).get("blocked"),
        }
        
        status = {
            "upload_status": self.status.get("uploadStatus"),
            "privacy_status": self.status.get("privacyStatus"),
            "license": self.status.get("license"),
            "embeddable": self.status.get("embeddable"),
            "made_for_kids": self.status.get("madeForKids"),
        ...
        return dict(**video_id, **snippet, **content, **status, **statistic, **kwargs)
